  ...
  return (
    ...
    <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
      ...
      <div className='flex flex-col'>
        ...
        <p className='mt-1'>
          <img className='inline-block w-5' src={assets.scream}/>
          <b>Lokify</b>
          •123,234,123 likes
          <b>•50 songs</b>
          ,about 2 hrs 30 min
    ...
    <div className='grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7]'>
      ...
      <img  className='m-auto w-5 'src={assets.clock_icon}/>
    </div>
    <hr />
    {
      songsData.map((item,index)=>(
        <div key={index} className='grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
          ...
          <p className='text-[15px] text-center  sm:block'>{item.duration}</p>
        </div>
      ))
    }
    </>
